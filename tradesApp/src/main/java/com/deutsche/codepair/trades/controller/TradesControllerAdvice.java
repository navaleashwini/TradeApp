...
public class TradesControllerAdvice extends ResponseEntityExceptionHandler{
    @ExceptionHandler(TradesExceptions.class)
    public ResponseEntity<VndErrors> notFoundException(final TradesExceptions e) {
